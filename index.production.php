...
|
*/
	$system_path = 'honolii_cluster/current/system/codeigniter';
 ...
 *
 */
	$application_folder = 'honolii_cluster/current/system/cms';
 ...
 *
 */
	$addon_folder = 'honolii_cluster/current/addons';
 ...
 */		
	...
	// Path to the views folder
	define('SPARKPATH', 'honolii_cluster/current/system/sparks/');
