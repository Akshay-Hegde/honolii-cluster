...
{
	if (strpos($_SERVER['SERVER_NAME'], 'local.') !== FALSE OR $_SERVER['SERVER_NAME'] == 'localhost' OR strpos($_SERVER['SERVER_NAME'], '.local') !== FALSE OR strpos($_SERVER['SERVER_NAME'], '.dev') !== FALSE)
	{
