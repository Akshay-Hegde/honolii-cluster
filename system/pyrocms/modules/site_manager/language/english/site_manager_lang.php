...
$lang['site.delete_site']		=	'You are fixing to nuke an entire site!!! Think about it... are you absolutely sure you want to?';
...
$lang['site.create_error']		=	'Sorry. The site could not be created %s';
$lang['site.edit_error']		=	'The changes could not be saved: %s';
$lang['site.chmod_error']		=	'The following locations are either not writeable or already exist: <br />%s';
$lang['site.rename_error']		=	'The site changes could not be saved';
...
$lang['site.site_manager']		=	'Site Manager';
$lang['site.user_manager']		=	'User Manager';

//labels
$lang['site.select_site']		=	'Select Site';
