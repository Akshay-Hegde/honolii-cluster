...
<div>
	...
	<fieldset id="user_names">
		<legend><?php echo lang('user_details_section') ?></legend>
				...
				<?php echo form_input('first_name', $_user->first_name, 'class="text"'); ?>

				<label for="last_name"><?php echo lang('user_last_name') ?></label>
				<?php echo form_input('last_name', $_user->last_name, 'class="text"'); ?>
...
*/ ?>
	<fieldset id="user_contact">
		<legend><?php echo lang('profile_contact_section') ?></legend>
				...
				<?php echo form_input('email', $_user->email, 'class="text"'); ?>
	
				<label for="phone"><?php echo lang('profile_phone') ?></label>
				<?php echo form_input('phone', $_user->phone, 'class="text"'); ?>
			
				<label for="mobile"><?php echo lang('profile_mobile') ?></label>
				<?php echo form_input('mobile', $_user->mobile, 'class="text"'); ?>
		
				<label for="address_line1">Address <?php echo lang('profile_address_line1') ?></label>
				<?php echo form_input('address_line1', $_user->address_line1, 'class="text"'); ?>
		
				<label for="address_line2">Address <?php echo lang('profile_address_line2') ?></label>
				<?php echo form_input('address_line2', $_user->address_line2, 'class="text"'); ?>
			
				<label for="address_line3">Address <?php echo lang('profile_address_line3') ?></label>
				<?php echo form_input('address_line3', $_user->address_line3, 'class="text"'); ?>
			
				<label for="postcode"><?php echo lang('profile_address_postcode') ?></label>
				<?php echo form_input('postcode', $_user->postcode, 'class="text"'); ?>
				<?php /*
				<label for="website"><?php echo lang('profile_website'); ?></label>
				<?php echo form_input('website', $_user->website, 'class="text"'); ?>
				*/ ?>
	</fieldset>
